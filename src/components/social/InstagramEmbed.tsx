        ...
        <div className="bg-gradient-to-r from-pink-500 to-purple-600 text-white p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-pink-100 text-sm">@rbetisescocia</p>
            </div>
          </div>
        </div>
      )}
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-center">
            <blockquote 
              ...
              data-instgrm-permalink="https://www.instagram.com/p/DKE4avDMvGH/?utm_source=ig_embed&utm_campaign=loading" 
            ...
            >
              <div style={{ padding: '16px' }}>
                <a 
                  href="https://www.instagram.com/p/DKE4avDMvGH/?utm_source=ig_embed&utm_campaign=loading" 
                  style={{
                    background: '#FFFFFF',
                    lineHeight: 0,
                    padding: '0 0',
                ...
                <p style={{
                  ...
                  <a 
                    ...
                    rel="noopener noreferrer"
                  >
                    A post shared by Peña Bética Escocesa &quot;No Busques Más Que No Hay&quot; (@rbetisescocia)
                  </a>
                </p>
              </div>
            </blockquote>
