...
const mockRecentMatches: Match[] = [
  ...
  },
  {
    ...
    score: { fullTime: { home: 0, away: 0 }, duration: 'REGULAR', halfTime: { home: 0, away: 0 } },
    stage: 'GROUP_STAGE',
    lastUpdated: new Date().toISOString(),
    season: { id: 1, startDate: '2025-06-01', endDate: '2025-08-31', currentMatchday: 1 },
  },
...
const mockFriendlyMatches: Match[] = [
  {
    id: 8,
    competition: { id: 0, name: 'Friendly', code: 'FR', type: 'FRIENDLY', emblem: '' },
    utcDate: new Date(new Date().getTime() + 4 * 24 * 60 * 60 * 1000).toISOString(),
    status: 'SCHEDULED',
    matchday: 1,
    homeTeam: { id: 90, name: 'Real Betis', shortName: 'Betis', tla: 'BET', crest: 'https://crests.football-data.org/90.png' },
    awayTeam: { id: 101, name: 'Team Y', shortName: 'TY', tla: 'TY', crest: '' },
    score: { fullTime: { home: null, away: null }, duration: 'REGULAR', halfTime: { home: null, away: null } },
    stage: 'GROUP_STAGE',
    lastUpdated: new Date().toISOString(),
    season: { id: 1, startDate: '2025-06-01', endDate: '2025-08-31', currentMatchday: 1 },
