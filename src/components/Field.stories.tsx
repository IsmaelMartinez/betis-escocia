...
const meta: Meta<typeof Field> = {
  ...
  argTypes: {
    ...
    htmlFor: {
      control: "text",
      description: "HTML for attribute for the label",
    },
    required: {
      control: "boolean",
...
export const Default: Story = {
  args: {
    ...
    htmlFor: "name",
    children: (
      <ValidatedInput id="name" type="text" placeholder="Enter your name" />
    ),
  },
};
...
export const RequiredField: Story = {
  args: {
    ...
    required: true,
    children: (
      <ValidatedInput id="email" type="email" placeholder="Enter your email" />
    ),
  },
};
...
export const WithTextarea: Story = {
  args: {
    ...
    htmlFor: "message",
    children: (
      <ValidatedTextarea id="message" placeholder="Your message" rows={4} />
    ),
  },
};
