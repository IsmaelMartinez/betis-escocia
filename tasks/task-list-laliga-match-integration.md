...
#### Next Priority: T24 Database Integration �️ **HIGH PRIORITY**

- **T16.3-T16.6**: Admin dashboard and email notifications for RSVP
- **T24**: Database Integration - Replace JSON files with proper database
- **T22.5**: Optional gallery enhancements (Instagram grid, contests)
...
## 🚀 **TASK STRUCTURE - ORGANIZED BY PRIORITY**
...
### 🗄️ **PHASE 4: DATABASE & ADMIN** 🚧 **CURRENT FOCUS**

#### T24: Database Integration with Supabase (Free Tier, Initial Version) 🗄️ **HIGH PRIORITY** 🆕 **UPDATED TASK**
- [ ] T24.1: Set up Supabase project (free tier) and configure environment variables
- [ ] T24.2: Design RSVP table schema (basic: name, email, message, created_at)
- [ ] T24.3: Implement scheduled job (Supabase Edge Function or pg_cron) to delete RSVPs 1 month after insertion
- [ ] T24.4: Update API routes to use Supabase for RSVP storage (replace JSON)
- [ ] T24.5: Migrate existing RSVP data from JSON to Supabase
- [ ] T24.6: Test RSVP system end-to-end with Supabase backend
- [ ] T24.7: Update admin dashboard to read from Supabase
- [ ] T24.8: Document current data retention (1 month auto-delete) and plan for future GDPR/PII cleanup

#### T16: RSVP System - Admin Features 📊 **HIGH PRIORITY**
...
#### T22.5: Transform galeria page 🚧 **OPTIONAL**
...
### T22: Social Media Integration & Photo Gallery Replacement 📱 **HIGH PRIORITY** ✅ **MOSTLY COMPLETED**
...
- [x] T22.2: Integrate Instagram feed in redes-sociales ✅ **COMPLETED**
  - [x] T22.2a: Add Instagram embed API integration ✅
  - [x] T22.2b: Create Instagram feed component with hashtag filtering ✅
  - [x] T22.2c: Display recent posts tagged with #BetisEscocia #PeñaBéticaEscocesa ✅
  - [x] T22.2d: Add Instagram Stories integration for live match content ✅
- [x] T22.3: Integrate Facebook feed in redes-sociales ✅ **COMPLETED**
  - [x] T22.3a: Add Facebook Graph API integration ✅
  - [x] T22.3b: Create Facebook posts feed component ✅
  - [x] T22.3c: Display latest posts from Peña Bética Escocesa page ✅
  - [x] T22.3d: Add Facebook Events integration for match viewing events ✅
- [x] T22.4: Enhanced social media experience ✅ **COMPLETED**
  - [x] T22.4a: Create unified social media dashboard in /redes-sociales ✅
  - [x] T22.4b: Add "Follow Us" buttons with direct links ✅
  - [x] T22.4c: Create social media posting guide with optimal times ✅
  - [x] T22.4d: Add QR codes for easy social media following ✅
- [ ] T22.5: Transform galeria page 🚧 **OPTIONAL**
  - [x] T22.5a: Convert galeria to social media showcase ✅
  - [ ] T22.5b: Add Instagram grid view of community posts
  - [ ] T22.5c: Create Facebook photo albums integration
