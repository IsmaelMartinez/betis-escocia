...
describe("GDPR Page", () => {
  ...
  it("should render GDPR content for authenticated users", async () => {
    ...
    expect(
      screen.getByText("Protección de Datos Personales"),
    ).toBeInTheDocument();
  });
  ...
  it("should render header with shield icon for unauthenticated users", async () => {
    ...
    expect(screen.getByText("Protección de Datos Personales")).toHaveClass(
      "text-3xl",
      "font-black",
      "text-betis-black",
    );
  ...
  it("should render data retention information for unauthenticated users", async () => {
    ...
    expect(
      screen.getByText(/Información sobre retención de datos/),
    ).toBeInTheDocument();
    expect(
      screen.getByText(
  ...
  it("should have proper page structure and styling", async () => {
    ...
    const mainContainer = screen
      .getByText("Protección de Datos Personales")
