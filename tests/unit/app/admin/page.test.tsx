...
vi.mock("@/components/admin/ContactSubmissionsList", () => ({
  default: vi.fn(() => (
    <div data-testid="contact-submissions">Contact Submissions</div>
  )),
}));
...
describe("AdminPage", () => {
  ...
  describe("Error Handling", () => {
    it("should handle authentication token errors", async () => {
      ...
      const { updateContactSubmissionStatus } =
        await import("@/lib/api/supabase");
  ...
  describe("Component Integration", () => {
    it("should have admin components available", async () => {
      ...
      const ContactSubmissionsList =
        await import("@/components/admin/ContactSubmissionsList");
