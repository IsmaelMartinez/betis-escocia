  ...
  describe("userQuerySchema", () => {
    ...
    describe("Invalid cases", () => {
      ...
      it("should reject non-integer values", () => {
        expect(() => userQuerySchema.parse({ limit: "50.5" })).toThrow(
          ZodError,
        );
        expect(() => userQuerySchema.parse({ offset: "25.7" })).toThrow(
          ZodError,
        );
      });
      ...
      it("should reject non-numeric strings", () => {
        ...
        expect(() => userQuerySchema.parse({ offset: "xyz" })).toThrow(
          ZodError,
        );
      });
    });
  ...
  describe("userUpdateSchema", () => {
    ...
    describe("Valid cases", () => {
      ...
      it("should validate partial updates", () => {
        const roleOnlyUpdate = userUpdateSchema.parse({
          userId: "user_123",
          role: "admin",
        });
        ...
        const bannedOnlyUpdate = userUpdateSchema.parse({
          userId: "user_456",
          banned: true,
        });
      ...
      it("should handle boolean banned values", () => {
        const bannedTrue = userUpdateSchema.parse({
          userId: "user_123",
          banned: true,
        });
        expect(bannedTrue.banned).toBe(true);

        const bannedFalse = userUpdateSchema.parse({
          userId: "user_123",
          banned: false,
        });
    ...
    describe("Invalid cases", () => {
      ...
      it("should reject missing userId", () => {
        expect(() => userUpdateSchema.parse({ role: "user" })).toThrow(
          ZodError,
        );
      });
      ...
      it("should reject invalid role", () => {
        ...
        try {
          ...
          expect(zodError.issues?.[0]?.message).toBe(
            "Rol debe ser user, moderator, o admin",
          );
        }
      });
      ...
      it("should reject non-boolean banned values", () => {
        expect(() =>
          userUpdateSchema.parse({ userId: "user_123", banned: "true" as any }),
        ).toThrow(ZodError);
        expect(() =>
          userUpdateSchema.parse({ userId: "user_123", banned: 1 as any }),
        ).toThrow(ZodError);
      });
    });
  });
    ...
    describe("Invalid cases", () => {
      it("should reject invalid datetime format", () => {
        ...
        try {
          ...
          const zodError = error as ZodError;
          expect(zodError.issues?.[0]?.message).toBe(
            "Fecha y hora deben tener formato ISO válido",
          );
        }
      });
      ...
      it("should reject opponent name too short", () => {
        ...
        try {
          ...
          const zodError = error as ZodError;
          expect(zodError.issues?.[0]?.message).toBe(
            "Nombre del oponente debe tener al menos 2 caracteres",
          );
        }
      });
      ...
      it("should reject opponent name too long", () => {
        ...
        try {
          ...
          const zodError = error as ZodError;
          expect(zodError.issues?.[0]?.message).toBe(
            "Nombre del oponente no puede exceder 100 caracteres",
          );
        }
      });
