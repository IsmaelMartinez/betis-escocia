  ...
  describe("spanishEmailSchema", () => {
    ...
    describe("Edge cases", () => {
      ...
      it("should handle special characters in email refine validation", () => {
        ...
        expect(() => spanishEmailSchema.parse(specialCases[0])).toThrow(
          ZodError,
        );
        expect(() => spanishEmailSchema.parse(specialCases[1])).toThrow(
          ZodError,
        );
  ...
  describe("errorResponseSchema", () => {
    describe("Valid cases", () => {
      ...
      it("should handle empty details array", () => {
        ...
        expect(() =>
          errorResponseSchema.parse(errorWithEmptyDetails),
        ).not.toThrow();
      });
  ...
  describe("successResponseSchema", () => {
    ...
    describe("Invalid cases", () => {
      ...
      it("should reject when success field is missing", () => {
        ...
        expect(() => successResponseSchema.parse(missingSuccess)).toThrow(
          ZodError,
        );
      });
