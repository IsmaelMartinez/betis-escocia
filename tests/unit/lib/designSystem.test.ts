...
describe("designSystem", () => {
  ...
  describe("typography", () => {
    it("should have correct font families", () => {
      expect(typography.fontFamily.primary).toBe(
        "var(--font-geist-sans, ui-sans-serif, system-ui)",
      );
      expect(typography.fontFamily.display).toBe(
        "var(--font-geist-sans, ui-sans-serif, system-ui)",
      );
    });
  ...
  describe("animations", () => {
    it("should have transition presets", () => {
      expect(animations.transition.fast).toBe(
        "transition-all duration-150 ease-in-out",
      );
      expect(animations.transition.normal).toBe(
        "transition-all duration-200 ease-in-out",
      );
      expect(animations.transition.slow).toBe(
