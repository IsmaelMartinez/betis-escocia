...
describe('apiUtils', () => {
  ...
  describe('createApiHandler', () => {
    const createMockRequest = (method: string = 'POST', body?: any): NextRequest => {
      const request = {
        method,
  ...
  describe('executeSupabaseOperation', () => {
    ...
    it('should return error for Supabase error', async () => {
      ...
      const result = await executeSupabaseOperation(operation, 'Custom error message');
  ...
  describe('getQueryParams', () => {
    ...
    it('should extract query parameters without schema', () => {
      const request = createMockRequestWithQuery('name=John&age=25&active=true');
