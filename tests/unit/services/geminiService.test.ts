...
describe('geminiService', () => {
  ...
  describe('analyzeRumorCredibility', () => {
    it('should analyze transfer rumor successfully', async () => {
      const mockResponse = {
        text: JSON.stringify({
          ...
          probability: 75,
          reasoning: 'El rumor menciona un fichaje específico con fuentes confiables',
          confidence: 'high',
        }),
      };
      ...
      expect(result.reasoning).toBe('El rumor menciona un fichaje específico con fuentes confiables');
    ...
    it('should handle JSON response wrapped in markdown code blocks', async () => {
      ...
      const result = await analyzeRumorCredibility('Title', 'Description', 'Source');
    ...
    it('should handle quota error (429) gracefully', async () => {
      ...
      expect(result.reasoning).toBe('No se pudo analizar este rumor automáticamente.');
    ...
    it('should include title, description, and source in prompt', async () => {
      ...
      await analyzeRumorCredibility('Test Title', 'Test Description', 'Test Source');
