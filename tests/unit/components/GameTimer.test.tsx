...
describe("GameTimer", () => {
  ...
  describe("Reset functionality", () => {
    ...
    it("resets timer when duration changes", () => {
      const { rerender } = render(
        <GameTimer {...defaultProps} duration={10} />,
      );
  ...
  describe("Edge cases", () => {
    it("handles zero duration gracefully", () => {
      const onTimeUpMock = vi.fn();
      render(
        <GameTimer {...defaultProps} duration={0} onTimeUp={onTimeUpMock} />,
      );
    ...
    it("handles negative duration", () => {
      const onTimeUpMock = vi.fn();
      render(
        <GameTimer {...defaultProps} duration={-5} onTimeUp={onTimeUpMock} />,
      );
  ...
  describe("Component lifecycle", () => {
    ...
    it("restarts timer when onTimeUp function changes", () => {
      ...
      const { rerender } = render(
        <GameTimer {...defaultProps} onTimeUp={onTimeUp1} />,
      );
  ...
  describe("Layout and styling", () => {
    ...
    it("applies correct progress bar classes", () => {
      ...
      const progressBar = document.querySelector(
        ".h-4.rounded-full.transition-all.duration-1000.ease-linear",
      );
      expect(progressBar).toBeInTheDocument();
    });
