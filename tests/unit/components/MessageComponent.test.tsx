...
describe("MessageComponent", () => {
  ...
  it("should render warning message with correct styling", () => {
    const { container } = render(
      <MessageComponent type="warning" message="Warning message" />,
    );
  ...
  it("should render info message with correct styling", () => {
    const { container } = render(
      <MessageComponent type="info" message="Information message" />,
    );
  ...
  it("should render messages with empty string", () => {
    const { container } = render(
      <MessageComponent type="success" message="" />,
    );
...
describe("FormSuccessMessage", () => {
  ...
  it("should render with custom title", () => {
    render(
      <FormSuccessMessage title="Custom Success" message="Form submitted" />,
    );
