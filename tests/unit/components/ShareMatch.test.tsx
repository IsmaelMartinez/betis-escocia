...
describe("ShareMatch", () => {
    ...
    it("encodes URL properly for WhatsApp", () => {
      ...
      expect(mockOpen).toHaveBeenCalledWith(
        expect.stringMatching(
          /https:\/\/wa\.me\/\?text=.*Real%20Betis%20vs%20Sevilla/,
        ),
        "_blank",
      );
    });
  ...
  describe("Twitter sharing", () => {
    ...
    it("encodes URL properly for Twitter", () => {
      ...
      expect(callArgs).toContain(
        "url=https%3A%2F%2Fbetis-escocia.com%2Fmatches%2F123",
      );
    });
  });
  ...
  describe("Button styling and accessibility", () => {
    ...
    it("displays correct icons", () => {
      ...
      const whatsappIcon = screen
        .getByTitle("Compartir en WhatsApp")
        .querySelector("svg");
      const twitterIcon = screen
        .getByTitle("Compartir en Twitter")
        .querySelector("svg");
  ...
  describe("Edge cases and error handling", () => {
    it("handles match with null scores", () => {
      ...
      render(
        <ShareMatch match={matchWithNullScores} opponent={mockOpponent} />,
      );
