...
describe('StockIndicator', () => {
  ...
  describe('Color classes', () => {
    it('applies red colors for out of stock', () => {
      ...
      expect(container).toHaveClass('text-red-600', 'bg-red-50', 'border-red-200');
    });
    ...
    it('applies orange colors for low stock', () => {
      ...
      expect(container).toHaveClass('text-orange-600', 'bg-orange-50', 'border-orange-200');
    });
    ...
    it('applies yellow colors for medium stock', () => {
      ...
      const container = screen.getByText('Stock limitado').closest('div');
      expect(container).toHaveClass('text-yellow-600', 'bg-yellow-50', 'border-yellow-200');
    });
  ...
  describe('Container styling', () => {
    ...
    it('adds custom className to base classes', () => {
      ...
      const container = screen.getByText('Stock limitado').closest('div');
      expect(container).toHaveClass('inline-flex', 'items-center', 'my-custom-class');
    });
  });
  ...
  describe('Component flexibility', () => {
    ...
    it('maintains consistent behavior across different props', () => {
      render(<StockIndicator stock={0} maxStock={100} showQuantity={false} className="test" />);
