...
vi.mock("next/image", () => ({
  default: vi.fn(
    ({ src, alt, onClick, className, fill, sizes, priority, ...props }) => (
      <img
        src={src}
        alt={alt}
        onClick={onClick}
...
describe("ImageGallery", () => {
  ...
  describe("Image display", () => {
    ...
    it("displays correct alt text for main image", () => {
      ...
      expect(
        screen.getByAltText("Test Product - Imagen 1"),
      ).toBeInTheDocument();
    });
  ...
  describe("Navigation with multiple images", () => {
    ...
    it("navigates to next image when next button is clicked", () => {
      ...
      expect(
        screen.getByAltText("Test Product - Imagen 2"),
      ).toBeInTheDocument();
    });
    ...
    it("wraps around to last image when at first image and previous is clicked", () => {
      ...
      expect(
        screen.getByAltText("Test Product - Imagen 3"),
      ).toBeInTheDocument();
    });
  });
  ...
  describe("Thumbnail strip", () => {
    ...
    it("highlights current thumbnail with correct styling", () => {
      ...
      const firstThumbnail = screen
        .getByAltText("Test Product - Miniatura 1")
        .closest("button");
    ...
    it("updates thumbnail highlighting when navigating", () => {
      ...
      const secondThumbnail = screen
        .getByAltText("Test Product - Miniatura 2")
        .closest("button");
  ...
  describe("Accessibility", () => {
    ...
    it("provides meaningful alt text for thumbnails", () => {
      ...
      expect(
        screen.getByAltText("Test Product - Miniatura 1"),
      ).toBeInTheDocument();
      expect(
        screen.getByAltText("Test Product - Miniatura 2"),
      ).toBeInTheDocument();
      expect(
        screen.getByAltText("Test Product - Miniatura 3"),
      ).toBeInTheDocument();
    });
  ...
  describe("Edge cases", () => {
    ...
    it("handles long product names", () => {
      const longName =
        "Very Long Product Name That Should Handle Properly In The Gallery Component";
