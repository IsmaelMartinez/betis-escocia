...
describe('Hero', () => {
  describe('Basic rendering', () => {
    it('renders hero section with correct structure', () => {
      ...
      expect(section).toHaveClass('relative', 'min-h-screen', 'bg-betis-black', 'text-white', 'overflow-hidden');
    });
    ...
    it('renders main tagline', () => {
      ...
      expect(screen.getByText('¡Viva er Betis manque pierda!')).toBeInTheDocument();
    });

    it('renders peña description', () => {
      render(<Hero />);

      expect(screen.getByText(/La peña del Real Betis en Edimburgo, Escocia/)).toBeInTheDocument();
  ...
  describe('Feature cards', () => {
    ...
    it('renders feature card descriptions', () => {
      ...
      expect(screen.getByText(/Nuestro hogar en Edimburgo/)).toBeInTheDocument();
  ...
  describe('Social media section', () => {
    it('renders social media heading', () => {
      ...
      expect(screen.getByText('Síguenos en nuestras redes:')).toBeInTheDocument();
    });
  ...
  describe('Next match preview', () => {
    ...
    it('renders match venue information', () => {
      ...
      expect(screen.getByText('¡15 minutos antes para asegurar sitio!')).toBeInTheDocument();
    });
  ...
  describe('Interactive elements', () => {
    ...
    it('includes hover and transition classes', () => {
      ...
      const featureCards = screen.getAllByText('Polwarth Tavern')[1].closest('div');
